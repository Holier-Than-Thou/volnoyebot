...
каз лог / каз лог все
каз аналитика
музей (можно ответом на сообщение игрока)
музей помощь
музей создать 10 золота Б / музей создать 10з Б
...
ответом сопернику либо с его @тегом;
«мот инфо» — статистика игрока, «мот топ» — рейтинг чата.
...
При ставке ва-банк за каждые 100 000 очков начисляется 1 золото.
Исключение — комбинация ровно из двух 7️⃣.
