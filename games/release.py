...
RELEASE_ID = "2026-07-29-farm-update-1"
RELEASE_SUMMARY = """🆕 Обновление бота

• Яйца питомцев теперь вылупляются автоматически.
• Команды фермы работают как с «каз», так и напрямую через «ферма».
• Командой «ферма приют N» можно освободить занятый слот.
• Добавлена таблица игроков по RTP: «каз топ RTP» и «каз топ RTP возр»."""
