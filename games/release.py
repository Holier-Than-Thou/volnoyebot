...
RELEASE_ID = "2026-07-31-museum"
RELEASE_SUMMARY = """🆕 Обновление бота

• Добавлен музей со статуями трёх размеров и шестью уровнями качества.
• Ва-банк приносит 1 золото за каждые 100 000 очков ставки, кроме комбинации
  ровно с двумя семёрками.
• Команды: «музей» и «музей создать 10 золота Б/Г/В».
• Доход всей экспозиции начисляется каждый завершённый час."""
