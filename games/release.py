...
RELEASE_ID = "2026-08-04-personal-max-bet"
RELEASE_SUMMARY = """🆕 Обновление бота

🎚 Добавлено ограничение максимальной ставки

• Команда «каз макс Х» устанавливает ваш персональный максимум.
• «каз макс нет» или «каз макс 0» снимает ограничение.
• Лимит действует и на ва-банк: будет поставлена сумма не больше максимума."""
