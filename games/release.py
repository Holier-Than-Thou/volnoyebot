...
RELEASE_ID = "2026-07-31-museum-short-gold"
RELEASE_SUMMARY = """🆕 Обновление бота

• Для создания статуй добавлены короткие обозначения золота:
  «музей создать 10з Б» и «музей создать Б 10 з».
• Полная форма «10 золота» продолжает работать."""
