...
RELEASE_ID = "2026-07-31-museum-help"
RELEASE_SUMMARY = """🆕 Обновление бота

🏛 Добавлена команда «музей помощь».

В справке описаны получение золота, размеры статуй, формула броска,
множители всех качеств, почасовой доход и пример расчёта."""
