...
RELEASE_ID = "2026-07-30-full-tops-profiles-min-bet-1"
RELEASE_SUMMARY = """🆕 Обновление бота

• Топы балансов и RTP теперь показывают всех игроков, пока список
  помещается в сообщение Telegram.
• Команды «каз баланс» и «ферма» ответом на сообщение показывают данные
  выбранного игрока.
• Минимальная ставка в казино снижена до 1 очка."""
