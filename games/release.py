...
RELEASE_ID = "2026-07-31-work-payout-first-command"
RELEASE_SUMMARY = """🆕 Обновление бота

• Пользователи без истории игр начнут получать зарплату только после своей
  первой команды боту.
• Зарплата приостанавливается, если игрок более 3 суток не использовал
  команды бота.
• Любая следующая команда снова включает начисление зарплаты."""
