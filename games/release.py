...
RELEASE_ID = "2026-08-03-museum-daily-income-cap"
RELEASE_SUMMARY = """🆕 Обновление бота

🏛 Ограничен суточный доход музея

• Музей теперь начисляет не более 300 000 очков за завершённые сутки.
• Все существующие статуи, их параметры и собственный доход сохранены."""
