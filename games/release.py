...
RELEASE_ID = "2026-07-31-museum-transaction-fix"
RELEASE_SUMMARY = """🆕 Обновление бота

🏛 Исправлено создание статуй

• Устранена ошибка старой схемы после перехода на суточный доход.
• При технической ошибке создания статуи золото теперь гарантированно
  возвращается на музейный счёт."""
