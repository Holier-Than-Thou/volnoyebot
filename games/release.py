...
RELEASE_ID = "2026-07-31-gold-grant-forward-filter"
RELEASE_SUMMARY = """🆕 Обновление бота

🥇 Добавлена выдача золота

• Администратор может выдать золото командой «каз выдать Х з» ответом
  на сообщение игрока или с указанием его ID.
• Текст в пересланных сообщениях больше не считается командой бота."""
