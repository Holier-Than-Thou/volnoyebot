...
RELEASE_ID = "2026-07-31-museum-full-announcement"
...
• Цвет показывает качество статуи, от 🟥 ужасного до 🟨 шедевра.
• Доход всей экспозиции начисляется за каждый завершённый час.
• Если суммарный доход музея отрицательный, начисляется 0 очков."""
