...
RELEASE_ID = "2026-07-31-daily-museum-income"
RELEASE_SUMMARY = """🆕 Обновление бота

🏛 Изменена механика музея

• При результате ниже нормального заготовка ломается, а статуя не создаётся.
• Потраченное на сломанную заготовку золото не возвращается.
• Отрицательных статуй больше нет.
• Доход статуй теперь начисляется за каждые завершённые сутки."""
