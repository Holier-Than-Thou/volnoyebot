...
RELEASE_ID = "2026-07-29-pet-genetics-1"
RELEASE_SUMMARY = """🆕 Обновление бота

• На ферме теперь 6 слотов, а яйца созревают от 5 до 60 минут.
• Гены яйца полностью скрыты до автоматического вылупления.
• Чистые питомцы имеют один признак; многопризнаковые гибриды доходнее,
  но стерильны.
• Скрещивание в среднем улучшает признаки потомства.
• Командой «ферма дать N» можно передать питомца или яйцо другому игроку.
• Питомцы получают случайные имена, а ферма показывает суммарный доход."""
